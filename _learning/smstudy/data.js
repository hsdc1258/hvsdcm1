(() => {
  ...
  // 검증 불변식: 5개 대단원, 17개 소단원, 기출 78문항과 개념 연습 20문항.
  ...
  const UNITS = [{
    ...
    subs: [{
      ...
      sections: [{
        ...
        title: '빈곤선과 빈곤율',
        points: ['빈곤선은 빈곤 여부를 가르는 소득 기준 금액이다.', '빈곤율은 그 기준 아래에 있는 가구나 개인의 비율이다.', '절대적 빈곤선도 나라와 시대에 따라 다르게 정해진다.'],
        trap: '빈곤선이 시대·사회를 넘어 고정돼 있다는 선지를 거른다.'
      }, {
        title: '사회적 소수자와 우대 조치',
        points: ['사회적 소수자는 수가 아니라 권력상 열세로 규정된다.', '식별 가능성·차별·집단 정체성이 함께 요구된다.', '적극적 우대 조치는 구조적 불이익을 보정하는 정책이다.'],
    ...
    id: 'V',
    title: '현대의 사회 변동',
    desc: '사회 변동, 세계화와 정보화, 인구 변화, 지속 가능한 사회',
    subs: [{
      id: 'V-01', title: '사회 변동과 사회 운동', time: 24,
      keywords: '진화론 · 순환론 · 기능론 · 갈등론 · 사회 운동',
      sections: [{
        title: '사회 변동의 방향',
        points: ['진화론은 사회가 단순한 형태에서 복잡한 형태로 발전한다고 본다.', '순환론은 사회가 생성과 성장과 쇠퇴를 반복한다고 본다.', '두 이론은 장기 변동을 설명하지만 세부 과정은 놓칠 수 있다.'],
        trap: '모든 사회가 같은 단계를 거친다는 주장은 진화론의 한계다.'
      }, {
        title: '사회 변동의 구조적 설명',
        points: ['기능론은 부분 간 부조화가 조정되며 균형을 회복한다고 본다.', '갈등론은 지배와 피지배의 모순이 변동을 이끈다고 본다.', '기술과 가치관과 제도의 변화 속도 차이는 문화 지체를 낳는다.'],
        trap: '비물질문화가 물질문화보다 늦게 변하면 문화 지체다.'
      }, {
        title: '사회 운동의 성립',
        points: ['사회 운동은 공동 목표를 이루려는 지속적이고 조직적인 행동이다.', '변혁 운동은 체제 전반을, 개혁 운동은 일부 제도를 바꾸려 한다.', '복고 운동은 과거 질서 회복을, 반동 운동은 변화 저지를 추구한다.'],
        trap: '일시적 군중 행동을 지속적인 사회 운동으로 판단하지 않는다.'
      }]
    }, {
      id: 'V-02', title: '세계화와 정보 사회', time: 22,
      keywords: '세계화 · 상호 의존 · 정보 격차 · 가상 공간 · 플랫폼',
      sections: [{
        title: '세계화의 양면성',
        points: ['세계화는 국경을 넘어 상품과 자본과 문화의 이동을 확대한다.', '국가 간 상호 의존이 커지지만 불평등과 문화 획일화도 나타난다.', '지역의 고유성을 세계 시장과 연결하는 세계 지역화가 나타난다.'],
        trap: '세계화가 국가의 역할을 완전히 없앤다는 선지는 틀리다.'
      }, {
        title: '정보 사회의 특징',
        points: ['정보와 지식이 핵심 자원이 되고 네트워크 조직이 확대된다.', '시공간 제약은 줄지만 익명성과 감시와 개인정보 문제가 커진다.', '생산자와 소비자의 경계가 약해져 정보 생산 참여가 늘어난다.'],
        trap: '정보량 증가가 정보의 신뢰성과 접근 평등을 보장하지 않는다.'
      }, {
        title: '정보 격차와 대응',
        points: ['정보 격차는 접근 기회와 활용 능력의 차이에서 함께 발생한다.', '디지털 기기 보급만으로 활용 능력 격차가 모두 해소되지는 않는다.', '미디어 이해 교육과 접근성 보장이 함께 이루어져야 한다.'],
        trap: '기기 보유율만으로 정보 격차 전체를 판단하지 않는다.'
      }]
    }, {
      id: 'V-03', title: '저출산·고령화와 다문화 사회', time: 26,
      keywords: '저출산 · 고령화 · 부양비 · 다문화 사회 · 사회 통합',
      sections: [{
        title: '저출산과 고령화',
        points: ['합계 출산율 하락은 장기적으로 생산 연령 인구를 줄인다.', '고령 인구 비율 증가는 노년 부양비와 복지 수요를 높인다.', '인구 변화는 노동과 교육과 주거 정책을 함께 바꾸게 한다.'],
        trap: '고령 인구 수와 고령 인구 비율을 같은 지표로 보지 않는다.'
      }, {
        title: '인구 구조 자료 읽기',
        points: ['유소년 부양비는 유소년 인구를 생산 연령 인구로 나눈 값이다.', '노년 부양비는 노년 인구를 생산 연령 인구로 나눈 값이다.', '총부양비는 유소년 부양비와 노년 부양비를 더한 값이다.'],
        trap: '분모는 전체 인구가 아니라 생산 연령 인구다.'
      }, {
        title: '다문화 사회와 통합',
        points: ['다문화 사회는 서로 다른 문화 배경의 구성원이 함께 사는 사회다.', '동화주의는 주류 문화 수용을, 다문화주의는 차이 존중을 강조한다.', '통합은 차별 해소와 권리 보장과 상호 문화 이해를 함께 요구한다.'],
        trap: '문화 차이 존중이 보편적 인권 침해까지 허용하지는 않는다.'
      }]
    }, {
      id: 'V-04', title: '전 지구적 문제와 지속 가능한 사회', time: 24,
      keywords: '기후 위기 · 환경 문제 · 국제 협력 · 지속 가능성 · 세대 간 형평성',
      sections: [{
        title: '전 지구적 문제의 성격',
        points: ['기후와 감염병과 난민 문제는 국경을 넘어 서로 영향을 준다.', '한 국가의 노력만으로 해결하기 어려워 국제 협력이 필요하다.', '원인 제공과 피해 부담이 달라 국가 간 책임 갈등이 생긴다.'],
        trap: '영향 범위가 넓다는 이유로 지역의 실천을 무의미하게 보지 않는다.'
      }, {
        title: '지속 가능한 발전',
        points: ['현재 세대의 필요와 미래 세대의 기회를 함께 고려한다.', '경제 성장과 사회 통합과 환경 보전을 함께 추구해야 한다.', '세대 간 형평성과 세대 내 형평성이 모두 핵심 기준이다.'],
        trap: '환경 보전만을 지속 가능한 발전의 전부로 보지 않는다.'
      }, {
        title: '해결 주체와 실천',
        points: ['정부는 규칙을 만들고 기업은 생산 방식과 책임을 바꾼다.', '시민 사회는 감시와 참여를 통해 공동 해결을 촉진한다.', '국제기구는 국가 간 기준과 정보와 협력을 조정한다.'],
        trap: '정부와 시장과 시민 사회 중 한 주체만으로 해결된다고 보지 않는다.'
      }]
    }]
  }];
  ...
  const VISUAL_GUIDES = {
    ...
    'V-01': {
      question: '사회 변동 이론과 운동 유형을 어떻게 구분할까?',
      flow: ['방향 확인', '원인 확인', '목표 범위'],
      checks: ['발전 방향이면 진화론이고 반복이면 순환론이다.', '부조화 조정은 기능론이고 구조적 모순은 갈등론이다.', '체제 전체인지 일부 제도인지 사회 운동의 범위를 본다.']
    },
    'V-02': {
      question: '세계화와 정보화의 양면성을 어떻게 읽을까?',
      flow: ['연결 확대', '기회 확인', '격차 확인'],
      checks: ['국경을 넘는 이동과 상호 의존의 확대를 확인한다.', '참여와 접근 기회가 누구에게 열렸는지 본다.', '기기 접근과 활용 능력의 격차를 따로 판단한다.']
    },
    'V-03': {
      question: '인구 구조와 다문화 통합을 어떻게 판단할까?',
      flow: ['인구 비율', '부양비 계산', '통합 원칙'],
      checks: ['인구 수와 전체 인구 중 비율을 구분한다.', '부양비의 분모가 생산 연령 인구인지 확인한다.', '차이 존중과 권리 보장을 함께 적용한다.']
    },
    'V-04': {
      question: '지속 가능한 해결책의 조건은 무엇인가?',
      flow: ['문제 범위', '형평성 확인', '주체 연결'],
      checks: ['국경을 넘는 상호 영향과 공동 책임을 확인한다.', '현재와 미래와 세대 내 형평성을 함께 본다.', '정부와 기업과 시민 사회와 국제기구를 연결한다.']
    }
  };
  ...
  // ---- 이모지 매핑 단일 원본 (docs/DESIGN.md §5) ----------------------------
  // 마크업에는 .emoji / .emoji-box / .emoji-lg 슬롯만 두고 글리프는 여기서만 정한다.
  // 대상↔이모지는 사이트 전체에서 일대일이다: 여기의 중단원 13개 글리프는 랜딩이 쓰는
  // 글리프(📗 📘 💾 🔁 📱)와 겹치지 않고, app 항목만 랜딩의 "사회·문화" 타일과 같은
  // 글리프를 공유한다(같은 대상이므로 같아야 한다).
  // scripts/validate.mjs의 validateSmStudyEmoji()가 이 규칙을 소스에서 도출해 강제한다.
  const EMOJI = {
    app: '📘',        // 사회·문화 (랜딩 타일과 같은 대상)
    'I-01': '🔭',     // 현상 판별 — 관찰
    'I-02': '🧪',     // 탐구 방법 — 실험
    'I-03': '🛡️',     // 연구 윤리 — 대상자 보호
    'II-01': '🗣️',    // 사회화 — 상호 작용
  ...
  const PRACTICE_BANK = [{
    sub: 'V-01', tags: ['진화론과 순환론', '문화 지체', '사회 운동'], items: [
      ['사회 변동을 일정한 방향의 발전 과정으로 보는 이론은?', ['순환론', '진화론', '낙인 이론', '갈등 이론', '교환 이론'], 2],
      ['사회가 생성과 성장과 쇠퇴를 반복한다고 보는 이론은?', ['진화론', '기능론', '순환론', '갈등론', '상호 작용론'], 3],
      ['기술의 변화 속도를 제도가 따라가지 못한 현상은?', ['문화 융합', '문화 동화', '문화 지체', '역할 갈등', '정보 격차'], 3],
      ['사회 체제 전반의 근본적 변화를 추구하는 운동은?', ['개혁 운동', '복고 운동', '변혁 운동', '반동 운동', '일시적 군중 행동'], 3],
      ['사회 운동의 일반적 특징으로 가장 적절한 것은?', ['우발적이고 일시적이다', '공동 목표를 지속적으로 추구한다', '개인 혼자 수행한다', '기존 질서 유지가 목적이다', '조직이 없어야 한다'], 2]
    ]
  }, {
    sub: 'V-02', tags: ['세계화의 양면성', '정보 사회', '정보 격차'], items: [
      ['세계화에 대한 설명으로 가장 적절한 것은?', ['국가 간 상호 의존을 줄인다', '국경을 넘는 이동을 확대한다', '모든 문화 차이를 없앤다', '국가 역할을 완전히 소멸시킨다', '경제 영역에만 영향을 준다'], 2],
      ['정보 사회의 특징으로 가장 적절한 것은?', ['정보와 지식의 가치가 낮아진다', '수직 조직만 강화된다', '네트워크 조직이 확대된다', '생산자와 소비자가 완전히 분리된다', '시공간 제약이 커진다'], 3],
      ['정보 격차를 줄이는 대책으로 가장 적절한 것은?', ['기기 보급만 실시한다', '활용 교육과 접근성 보장을 병행한다', '정보 생산을 제한한다', '온라인 공공 서비스를 중단한다', '개인 책임만 강조한다'], 2],
      ['세계 지역화의 사례로 가장 적절한 것은?', ['지역 문화를 없앤다', '지역 고유 상품을 세계 시장에 맞게 알린다', '모든 상품을 하나로 표준화한다', '국제 교류를 금지한다', '외국 문화를 무조건 모방한다'], 2],
      ['정보량 증가만으로 보장되지 않는 것은?', ['정보 저장', '정보 전송', '정보의 신뢰성과 접근 평등', '온라인 참여', '네트워크 연결'], 3]
    ]
  }, {
    sub: 'V-03', tags: ['저출산과 고령화', '인구 부양비', '다문화 통합'], items: [
      ['노년 부양비의 계산식으로 옳은 것은?', ['노년 인구÷전체 인구', '노년 인구÷생산 연령 인구', '생산 연령 인구÷노년 인구', '유소년 인구÷노년 인구', '노년 인구÷유소년 인구'], 2],
      ['총부양비에 대한 설명으로 옳은 것은?', ['유소년 부양비와 노년 부양비의 합이다', '전체 인구와 같다', '고령 인구 수만 반영한다', '출산율과 같은 지표다', '분모가 노년 인구다'], 1],
      ['저출산의 장기적 영향으로 가장 적절한 것은?', ['생산 연령 인구가 반드시 증가한다', '노년 부양비가 낮아진다', '생산 연령 인구가 감소할 수 있다', '복지 수요가 사라진다', '교육 정책에 영향이 없다'], 3],
      ['다문화주의에 대한 설명으로 옳은 것은?', ['주류 문화만 수용하게 한다', '문화적 차이와 권리를 존중한다', '보편적 인권을 부정한다', '문화 간 교류를 막는다', '모든 집단을 분리한다'], 2],
      ['다문화 사회 통합에 필요한 원칙은?', ['차별 방치', '권리 제한', '차별 해소와 상호 이해', '동일한 생활 방식 강제', '이주 배경 은폐'], 3]
    ]
  }, {
    sub: 'V-04', tags: ['전 지구적 문제', '지속 가능한 발전', '해결 주체'], items: [
      ['전 지구적 문제의 특징으로 가장 적절한 것은?', ['한 지역에만 영향을 준다', '한 국가만으로 쉽게 해결한다', '국경을 넘어 상호 영향을 준다', '국제 협력이 불필요하다', '원인과 피해 부담이 항상 같다'], 3],
      ['지속 가능한 발전의 의미로 옳은 것은?', ['현재 세대의 필요만 본다', '미래 세대의 기회를 함께 고려한다', '환경만 고려한다', '경제 성장을 금지한다', '사회적 형평성을 배제한다'], 2],
      ['세대 간 형평성의 사례로 가장 적절한 것은?', ['미래 세대가 쓸 자원을 고려한다', '현재 집단 간 격차만 본다', '기업 이익만 확대한다', '환경 비용을 미래로 넘긴다', '국제 협력을 중단한다'], 1],
      ['전 지구적 문제 해결에서 시민 사회의 역할은?', ['법률을 독점 제정한다', '감시와 참여로 공동 해결을 촉진한다', '국가 간 조약을 단독 체결한다', '생산을 전면 통제한다', '국제기구를 해산한다'], 2],
      ['지속 가능한 사회를 위한 접근으로 옳은 것은?', ['정부만 책임진다', '시장만 책임진다', '여러 주체의 역할을 연결한다', '지역 실천은 무의미하다', '세대 내 형평성은 배제한다'], 3]
    ]
  }];
  const PRACTICE_ROWS = PRACTICE_BANK.flatMap(({ sub, tags, items }) => items.map(([stem, choices, answerNumber], index) => ({
    id: `PRACTICE-${sub}-${String(index + 1).padStart(2, '0')}`,
    sub, year: 2027, session: '개념 연습', number: index + 1,
    answerNumber, correctRate: 70, wrongRate: 30, tags, stem, choices
  })));
