...
function validateGlobalsAndOrder() {
  ...
  const expectedOrders = {
    ...
    'usage/index.html': ['/usage/assets/js/usage.js?v=20260830-guide-v1'],
  ...
  const expectedStylesheets = {
    ...
    'usage/index.html': ['/assets/css/system.css?v=20260830-guide-v1', '/usage/assets/css/usage.css?v=20260830-guide-v1'],
