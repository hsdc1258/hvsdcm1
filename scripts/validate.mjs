...
function validateGlobalsAndOrder() {
  ...
  const expectedOrders = {
    ...
    'usage/index.html': ['/usage/assets/js/usage.js?v=20260829-control-tower'],
  ...
  const expectedStylesheets = {
    ...
    'usage/index.html': ['/assets/css/system.css?v=20260829-control-tower', '/usage/assets/css/usage.css?v=20260829-control-tower'],
