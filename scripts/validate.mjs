...
function validateGlobalsAndOrder() {
  ...
  const expectedOrders = {
    ...
    'usage/index.html': ['/usage/assets/js/usage.js?v=20260828-usage-terms'],
  ...
  const expectedStylesheets = {
    ...
    'usage/index.html': ['/assets/css/system.css?v=20260828-usage-terms', '/usage/assets/css/usage.css?v=20260828-usage-terms'],
