...
function validateGlobalsAndOrder() {
  ...
  const expectedOrders = {
    ...
    'usage/index.html': ['/usage/assets/js/usage.js?v=20260829-orgchart-v9'],
  ...
  const expectedStylesheets = {
    ...
    'usage/index.html': ['/assets/css/system.css?v=20260829-orgchart-v9', '/usage/assets/css/usage.css?v=20260829-orgchart-v9'],
