(() => {
  ...
  const UNITS = [{
    ...
    subs: [{
      ...
      sections: [{
        title: '양적 연구와 질적 연구',
        points: ['양적 연구는 방법론적 일원론·실증주의에 기초해 수치 자료로 변인 관계와 일반 법칙을 찾고, 주로 연역적으로 가설을 검증한다.', '질적 연구는 방법론적 이원론·해석주의에 기초해 언어·행동·경험을 통해 동기와 맥락을 이해하고, 주로 귀납적으로 개념을 만든다.', '두 연구 모두 경험적 자료를 사용한다. 수능에서는 질문지법·실험법을 양적 연구, 면접법·참여 관찰법을 질적 연구의 대표 방법으로 연결하며, 문헌 연구법은 양쪽에서 모두 사용할 수 있다.'],
        trap: '수능에서는 질문지법·실험법을 양적 연구, 면접법·참여 관찰법을 질적 연구의 대표 방법으로 먼저 연결한다. 문헌 연구법은 양쪽에서 모두 활용할 수 있다.'
      }, {
        title: '가설·변인·가치 중립',
        ...
        points: ['1차 자료는 현재 연구 목적을 위해 연구자가 직접 새로 수집한 자료다. 같은 연구자의 과거 자료라도 새로운 연구에 다시 사용하면 2차 자료가 된다.', '질문지법은 많은 사람에게 표준화된 질문을 하고 통계적으로 처리하기에 좋다. 면접법은 소수의 응답자에게 자세한 이야기를 듣는 데 좋고, 참여 관찰법은 실제 생활 모습을 깊이 이해하는 데 좋다.', '실험법은 독립 변인을 조작하고 다른 조건을 통제해 인과 관계를 확인한다. 문헌 연구법은 이미 만들어진 통계·기록·문서를 활용하므로 양적 연구와 질적 연구 모두에서 사용할 수 있다.'],
    ...
    subs: [{
      ...
      sections: [{
        title: '문화 변동 요인',
        points: ['발견은 이미 존재하지만 알려지지 않았던 자연 법칙이나 자원을 알아내는 것이다. 발명은 한 사회에 없던 문화 요소를 새로 만드는 것이다.', '1차적 발명은 기존 문화 요소와 관계없이 완전히 새로운 요소를 만드는 것이고, 2차적 발명은 이미 있는 문화 요소나 원리를 응용해 새로운 요소를 만드는 것이다. 활을 만든 것은 1차적 발명, 활의 원리를 이용해 현악기를 만든 것은 2차적 발명의 대표 사례다.', '직접 전파는 사람들의 직접 접촉, 간접 전파는 책·방송·인터넷 같은 매체를 통해 문화가 전달되는 것이다. 자극 전파는 외부 문화의 아이디어에 자극받아 자기 사회에서 새로운 요소를 만드는 것이다.'],
        trap: '2차적 발명은 자기 사회에 이미 있는 문화 요소를 응용한 내재적 변동이다. 자극 전파는 외부 문화의 아이디어가 원인이 된 외재적 변동이라는 점에서 다르다.'
      }, {
        title: '문화 접변 결과',
        points: ['문화 공존은 서로 다른 두 문화가 접촉한 뒤에도 각각의 정체성을 유지하는 결과다.', '문화 동화는 접촉한 문화 가운데 한쪽의 정체성이 사라지는 결과다. 문화 융합은 기존 두 문화와 다른 새로운 제3의 문화가 만들어지는 결과다.', '문화 저항은 외래문화를 받아들이지 않고 기존 문화를 지키려는 반응이다. 동화는 자발적으로 나타날 수도 있고 강제적으로 나타날 수도 있다.'],
  ...
  const VISUAL_GUIDES = {
    ...
    'I-02': {
      ...
      flow: ['연구자가 한 행동 찾기', '대표 연구 방법 연결', '변인·표본 확인'],
      checks: ['질문지·실험은 양적 연구, 면접·참여 관찰은 질적 연구에 먼저 연결한다.', '독립 변인과 종속 변인, 조작적 정의가 실제 측정 지표에 맞는지 확인한다.', '모집단·표본, 1차·2차 자료, 각 자료 수집법의 장단점을 서로 섞지 않는다.']
    },
    'I-03': {
    ...
    'III-03': {
      question: '문화가 왜, 어떻게 변했고 무엇이 남았는가?',
      flow: ['변화가 시작된 곳', '문화가 전달된 방식', '접촉 뒤에 남은 문화'],
      checks: ['발견·1차적 발명·2차적 발명과 직접·간접·자극 전파의 발생 조건을 구분한다.', '두 문화가 모두 남았는지, 한쪽이 사라졌는지, 제3의 문화가 생겼는지 확인한다.', '다문화주의는 문화적 차이의 인정과 보편적 인권·공통 규범을 함께 요구한다.']
    },
    'IV-01': {
