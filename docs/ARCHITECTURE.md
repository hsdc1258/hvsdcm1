...
| `GET /api/behavior-lab/dashboard?symbol=...&period=...` | behavior owner | Validated live Bitget public-market snapshot and explanatory candidate; fixed enum and exact seven upstream GET boundary |
